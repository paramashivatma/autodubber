...
_FILE_LOGGER = None
_LOG_DIR = None
_API_CALL_COUNTS = {"gemini": 0, "mistral": 0, "glm": 0, "deepgram": 0, "total": 0}
...
def count_api_calls_from_logs(log_file=None):
    ...
    if not os.path.exists(log_file):
        return {"gemini": 0, "mistral": 0, "glm": 0, "deepgram": 0, "total": 0}

    counts = {"gemini": 0, "mistral": 0, "glm": 0, "deepgram": 0, "total": 0}
