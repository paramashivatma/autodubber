# AutoDub Studio (Video Dubber v1.20)
Desktop GUI tool to:
...
3. Transcription (local Whisper-large-v3 via faster-whisper)
...
Ensure `faster-whisper` is installed (`pip install faster-whisper`) and that the Whisper model weights can be downloaded/loaded.
